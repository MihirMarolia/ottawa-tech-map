...
module.exports = {
  forbidden: [
    ...
    },
    {
      ...
      to: {
        path: [
          "^src/packages/signal-ingestion/",
          "^src/packages/entity-resolver/",
          "^src/packages/privacy-gateway/",
          "^src/packages/company-intelligence-scorer/",
          "^src/packages/institutional-import/",
          "^src/packages/database/",
          "^src/apps/intelligence-service/",
        ],
      },
    },
  ],
